...
> 详细教程内容见 [教程目录](../gpu-ops-tutorial/README.md)，这里放"面试版"精简文档。

## 已完成

| 文档 | 内容 | 状态 |
|------|------|:---:|
| [01 GPU 硬件](01-hardware.md) | GPU 架构、选型、MIG、PCIe 拓扑 | 📝 待写 |
| [02 GPU 软件栈](02-software-stack.md) | 驱动/CUDA/cuDNN/NCCL 关系、版本对齐 | 📝 待写 |
